 ...
 */
int mlo_parseAssociatedDeviceDiagnostics(void *jsonVal, wifi_associated_dev_t **associated_dev, bool **mld_enable_list, char ***band_list, uint32_t *assocDevCount, char **vapIndex);
